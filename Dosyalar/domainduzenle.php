...
<div class="container">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h5 class="m-0 font-weight-bold text-primary">Domain Düzenle</h5>
    </div>
    <div class="card-body">
      <form action="islemler/islem.php" method="POST" enctype="multipart/form-data">
        <div class="form-row">
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="domain_adi" placeholder="Domain Adı" value="<?php echo $domaincek['domain_adi'] ?>">
          </div>
          <div class="form-group col-md-4">
            <label>Müşteri</label>
        ...
        <div class="form-group col-md-4">
          ...
          <input type="date" class="form-control" name="domain_baslangic" placeholder="Domain Başlangıç" value="<?php echo $domaincek['domain_baslangic'] ?>">
        </div>
      </div>
      <div class="form-row">
       <div class="form-group col-md-4">
        <label>Domain Kayıt Firması <small>(Örn:Godaddy)</small></label>
        <input type="text" class="form-control" name="domain_kayit_firmasi" placeholder="Domain Kayıt Firması" value="<?php echo $domaincek['domain_kayit_firmasi'] ?>">
      </div> 
      <div class="form-group col-md-4">
      ...
      <div class="form-group col-md-4">
        <label>Fiyat</label>
        <input type="text" class="form-control" name="domain_fiyat" placeholder="Domain Başlangıç" value="<?php echo $domaincek['domain_fiyat'] ?>">
      </div>                           
    </div>    
